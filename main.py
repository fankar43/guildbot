...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]Fankar Reg    
[FFD700]✨ Name on TikTok : [FFFFFF] Fankar Reg   
[FF0000]╚══════════╝
[FFD700]✨ Developer: Fankar Reg  OP —͟͞͞ </> Fankar Reg  ❄️  ⚡
"""
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To F A N K A R ˣ ʙᴏᴛ"
...
[00FFFA]║
[FFFF00]║ 👤 Developer: Fankar Reg    :: [FF1493]MR ROBOTT
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]ENHANCED A3
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = '4305420533','E3F804B90F2D5FA89E7DEF0DD24DF579A5AAA23940692F4183BB097A80720015'
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using Fankar Reg ")
    sys.exit(0)
...
async def StarTinG():
    while True:
        try:
            ...
            print("👋 Thanks for using Fankar Reg P!")
            break
